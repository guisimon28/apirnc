...
public record Ville(String codeOfficiel, String nomOfficiel, String codeOfficielArrondissement, String nomOfficielArrondissement, Departement departement, Region region) {
	public static class Builder {
		...
		public Ville build() {
			return new Ville(codeOfficiel, nomOfficiel, codeOfficielArrondissement, nomOfficielArrondissement, departement, region);
		}
	}
}